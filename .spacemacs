...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(python
     ...
     markdown
     (org :variables
          org-todo-dependencies-strategy 'semi-auto
